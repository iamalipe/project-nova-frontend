...
const columns: ImportColumn[] = [
  { key: "name", label: "Name", description: "Warehouse Name", required: true, type: "string" },
  { key: "warehouseCode", label: "Warehouse Code", description: "6-character unique code", required: true, type: "string" },
...
const sampleCSV = `name,warehouseCode,addressLine1,zip,countryId,stateId,yearlyUpkeep
Central Hub,WRH001,456 Industrial Pkwy,90210,00000000-0000-0000-0000-000000000000,00000000-0000-0000-0000-000000000000,25000`;

export default function WarehouseImportDialog({ state: _state }: { state: DialogStateType }) {
  ...
  const handleImport = async (validData: any[]) => {
    return apiQuery.warehouse.createMany(validData);
  };
  ...
  return (
    <BulkImportDialog
      ...
      description="Upload a CSV file or paste raw CSV text to import warehouses in bulk."
      columns={columns}
