...
const tableColumns: DataTableColumn<WarehouseType>[] = [
  {
    key: "select",
    label: "Select",
  ...
  },
  {
    ...
    key: "warehouseCode",
    render: (record) => record.warehouseCode,
    isSortable: true,
  ...
  {
    label: "Supplied Stores",
    key: "supplyStoreIds",
    render: (record) => `${record.supplyStoreIds.length} Store(s)`,
    isSortable: false,
  },
  {
    label: "Yearly Upkeep",
