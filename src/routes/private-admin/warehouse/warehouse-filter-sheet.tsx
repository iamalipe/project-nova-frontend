import type { ApiWarehouseGetAllParams } from "@/api/warehouse-api";
...
interface WarehouseFilterSheetProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  filters: ApiWarehouseGetAllParams;
  onApplyFilters: (filters: Partial<ApiWarehouseGetAllParams>) => void;
  onResetFilters: () => void;
}

export default function WarehouseFilterSheet({
  open,
  onOpenChange,
  filters,
  onApplyFilters,
  onResetFilters,
}: WarehouseFilterSheetProps) {
    ...
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="flex flex-col">
        <SheetHeader>
          ...
          <SheetDescription>Filter warehouse records by location parameters.</SheetDescription>
        </SheetHeader>
